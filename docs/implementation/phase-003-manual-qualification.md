...
| CNT-05 | REQUIRED | Exercise an ordinary ZIP or 7z single-game archive through admission, extraction/identification, and Library presentation. | A supported single-game archive follows the documented path and produces one coherent logical game; any bounded failure is understandable and non-destructive. | NOT RUN |  |  |  | — |
