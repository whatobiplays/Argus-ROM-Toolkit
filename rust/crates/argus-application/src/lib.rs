...
pub use sources::{
    ...
    LocalFilesystemProvider, LocalFilesystemRootSelection, NewLibraryRoot, ObservedEntryKind,
    ProviderError, RelativeSourceLocator, RemoveLibraryRootCommand, RemoveLibraryRootHandler,
